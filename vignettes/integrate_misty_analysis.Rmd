...
# Tests purely spatial predictive power without the cell's own composition
...
```{r, eval = FALSE}
# Collect aggregated results from the random forest model version of the complete analysis 
